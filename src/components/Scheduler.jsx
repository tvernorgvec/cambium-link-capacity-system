  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <Card>
          <h3 className="text-lg font-medium text-gray-900 mb-4">Schedule New Test</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              >
                ...
                {accessPoints.filter(ap => ap.online).map((ap) => (
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
        <Card>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900">Scheduled Tests</h3>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          ...
                          {test.testType === 'flood' ? 'Flood Mode' : 'Individual'}
                        </span>
                      </div>
                      <div>
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
